...
const AdminLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex bg-slate-50">
      {/* Sidebar */}
      <aside
        className={`flex flex-col bg-white text-slate-600 transition-all duration-300 border-r border-slate-200 z-50 ${collapsed ? 'w-20' : 'w-64'
          }`}
      >
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-[#f8fafc]">
        {/* Top Header */}
        <header className="h-[72px] flex items-center justify-between px-6 bg-white/80 backdrop-blur-md shadow-sm xl:px-8 z-40 sticky top-0">
          {/* Breadcrumbs */}
          <div className="flex flex-col">
