    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-body-md text-neutral-500">Sign in to your account to continue</p>
        </div>
        ...
        <div className="card p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-caption">
              <span className="bg-white px-3 text-neutral-500">or sign in with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="btn-primary btn-lg w-full mt-2">
              Sign In
            </button>
          </form>
        </div>
